...
class NBWMentionTableViewController: UITableViewController {
    ...
    func fetchMentionsDataFromWeibo(){
       Alamofire.request(.GET, mentionsURLString, parameters: ["access_token":accessToken,"count":5], encoding: ParameterEncoding.JSON, headers: nil)
    ...
    //Mark: - CoreData 
    func importJSONIntoCoreData(array:NSArray){
