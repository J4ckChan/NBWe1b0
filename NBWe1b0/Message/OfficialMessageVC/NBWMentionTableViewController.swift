...
class NBWMentionTableViewController: UITableViewController {
    ...
    func configureMentionTabelViewCell(mention:WeiboStatus,_ cell:UITableViewCell){
        ...
        repostButton.addTarget(self, action: #selector(NBWMentionTableViewController.repostWeiboStatus(_:)), forControlEvents: .TouchUpInside)
        ...
        commentButton.addTarget(self, action: #selector(NBWMentionTableViewController.commentWeiboStatus(_:)), forControlEvents: .TouchUpInside)
        ...
        likeButton.addTarget(self, action: #selector(NBWMentionTableViewController.likeWeiboStatus(_:)), forControlEvents: .TouchUpInside)
        ...
        arrowButton.addTarget(self, action: #selector(NBWMentionTableViewController.arrowWeiboStatus(_:)), forControlEvents: .TouchUpInside)
