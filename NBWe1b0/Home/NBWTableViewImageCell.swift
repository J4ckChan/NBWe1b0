...
//        print("The Height of Cell is: \(cellHeight)\n bodyLabelHeigt:\(bodyLabelHeight)\n imageHeight:\(imageHeight * numberOfImageRow)")
    ...
    func setupRespotCommentLikeBarView(){
        ...
        self.repostButton?.titleLabel?.font = UIFont.systemFontOfSize(15, weight: UIFontWeightThin)
        ...
        self.commentButton?.titleLabel?.font = UIFont.systemFontOfSize(15, weight: UIFontWeightThin)
        ...
        self.likeButton?.titleLabel?.font = UIFont.systemFontOfSize(15, weight: UIFontWeightThin)
