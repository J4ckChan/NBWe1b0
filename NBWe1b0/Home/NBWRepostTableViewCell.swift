//
//  NBWRepostTableViewCell.swift
//  NBWe1b0
//
//  Created by ChanLiang on 2/5/16.
//  Copyright © 2016 JackChan. All rights reserved.
//

import UIKit

class NBWRepostTableViewCell: UITableViewCell {
    ...
    func configureRepostTableViewCell(comment:NBWComment,viewWidth:CGFloat){
        ...
        self.createdAtLabel.text                = comment.createdAt
